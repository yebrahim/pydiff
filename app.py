...
def highlight_diffs():
    ...
    while line:
        ...
        if line['code'] == DiffCode.SIMILAR:
            leftFileTextArea.insert('end', line['line'] + '\n')
            rightFileTextArea.insert('end', line['line'] + '\n')
        elif line['code'] == DiffCode.RIGHTONLY:
            leftFileTextArea.insert('end', '\n')
            rightFileTextArea.insert('end', line['line'] + '\n', 'green')
        elif line['code'] == DiffCode.LEFTONLY:
            leftFileTextArea.insert('end', line['line'] + '\n', 'red')
            rightFileTextArea.insert('end', '\n')
